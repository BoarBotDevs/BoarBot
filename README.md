...
<img src="https://github.com/user-attachments/assets/21a7ef07-e051-4f9b-bfc8-a67cea0e686e" alt="user getting the uncommon boar Boarigami from using /boar daily">
	
### Market
Allows the user to buy and sell both boars and powerups.

<img src="https://github.com/user-attachments/assets/598ba305-dae3-40b2-a5c1-c2eed999ba56" alt="various listings of boars on the market">
  
### Leaderboard
Shows how good players are compared to others on many different categories. 

<img src="https://github.com/user-attachments/assets/631e245a-a76f-4807-a694-da00969ba4a1" alt="the top users on the Unique Boars leaderboard">
...
<img src="https://github.com/user-attachments/assets/2a8d0300-26fc-4be3-9951-794c0f8fd6c8" alt="the main profile page of a user, shows that they have 748 blessings, 250 from streak, 234 from unique boars, 214 from quests, and 50 from other blessings">

### Collection
Shows all of a players boars at once.

<img src="https://github.com/user-attachments/assets/1be6fb36-9056-499f-bf78-57167cddcb20" alt="a users collection, shows many different various boars">

### Compendium
Shows specific boars in detail. This is also where you can interact with your boars!

<img src="https://github.com/user-attachments/assets/de64a99b-a0e2-4dec-a681-5f294fbd40f2" alt="detailed information about Carrot Boar, showing it's picture, description, amount owned, and classification, which is sustenence. The description reads: On the surface, this boar is indistiguishable from the grass around it. The only being capable of spotting them is Farmer Boar.">

### Stats
Shows detailed statistics about all areas of BoarBot

<img src="https://github.com/user-attachments/assets/7a6f0fde-b07a-46fa-8329-cad2caa34f55" alt="the first page of a user's statistics">

### Powerups
Displays all of the powerups that a player currently has, along with their blessing count.

<img src="https://github.com/user-attachments/assets/94aa59c3-7944-4e0a-82cd-68f5808abe31" alt="the page showing a users powerups. this user has 406 boar blessings, 59 miracle charms, 95 cloning serums, 20 boar gifts, and 11/30 transmutation charges">
   
### Quests
Shows the weekly quests and the rewards for those quests.

<img src="https://github.com/user-attachments/assets/7a365efb-d33c-4ca6-88b4-7ed8598512c4" alt="shows a users quests, when the quests will reset, how many quests have been completed, that the perfect bonus is not claimed, and how many times the user has completed all quests on a gievn week">

### Badges
Displays a players badges and the details about those badges.

<img src="https://github.com/user-attachments/assets/21025bbc-025e-4942-818a-a6352c9fc945" alt="shows the Boartist Follower badge and it's description. There are clickable arrows pointing left to be used to show other badges. The description of the Badge reads: Given to users that heavily inspired a boar that was added to BoarBot.">

### Advent
During December, you claim daily rewards on the Advent Calander.

<img src="https://github.com/user-attachments/assets/bc690090-d717-423f-910a-6f660f27e925" alt="a users advent calander. it is currently day 3 of the advent calander and the previous 2 days have been claimed">
...
<img src="https://github.com/user-attachments/assets/e8394bfd-7aee-4922-8b79-bb9ae26d5c1c" alt="shows the quick click powerup occuring. there is 8 gray buttons and one blue button. text in the middle says: Click The Blue Button! Reward: 1 Miracle Charm.">
...
<img src="https://github.com/user-attachments/assets/f90d45f6-2965-403f-8e09-989993923714" alt="shows a users blessings. they have 748 blessings, 250 from streak, 234 from unique boars, 214 from quests, and 50 from other blessings">
...
<img src="https://github.com/user-attachments/assets/fb71907b-8b94-41f4-9032-cb1ef19fc16a" alt="shows the confirmation screen for using miracle charms. text in the middle says: Are you sure? This will use 15 Miracle Charms, boosting your Boar Blessings to 3,138.">

### Clones
Clones will allow a player to duplicate a boar they already have. The rarer the boar, the more clones it takes!

<img src="https://github.com/user-attachments/assets/ae8f5483-de55-482e-93c3-30c3dbe50d4b" alt="shows the confirmation screen for using clones. text in the middle says: Are you sure? This will use 3 cloning serums, granting you 3 bors.">
...
<img src="https://github.com/user-attachments/assets/5ebe158f-59da-4544-a930-7d959b56f8a2" alt="a boar gift. it is currently inactive and displays 8 gray buttons under it">
